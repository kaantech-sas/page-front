  ...
  return (
    <section className="relative py-32 bg-black overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <Card className="bg-black/60 backdrop-blur-xl border border-[#D4AF37]/30 rounded-none p-8 lg:p-12">
            {/* Header */}
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="space-y-6">
                <div>
                  <Label htmlFor="investment" className="text-white mb-2 block text-lg">
                  ...
                  <Input
                    ...
                    className="bg-white/5 border-white/20 text-white text-xl py-6 rounded-none focus:border-[#00F0FF]"
                  />
                </div>
                <div>
                  <Label htmlFor="revenue" className="text-white mb-2 block text-lg">
              ...
              <motion.div
                ...
                className="space-y-4"
              >
                <div className="bg-white/5 backdrop-blur-sm border border-[#00F0FF]/30 p-6 rounded-none">
                  <div className="flex items-center gap-2 mb-2">
                    <TrendingUp className="w-5 h-5 text-[#00F0FF]" />
                    <span className="text-white/70 text-sm">ROI Proyectado (12 meses)</span>
                  </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-[#D4AF37]/30 p-6 rounded-none">
                  <span className="text-white/70 text-sm block mb-2">Aumento de Ingresos</span>
                  <div className="text-3xl font-bold text-[#D4AF37]">
                    ${(results.revenueIncrease / 1000000).toFixed(1)}M
                  </div>
                </div>

                <div className="bg-white/5 backdrop-blur-sm border border-white/20 p-6 rounded-none">
                  <span className="text-white/70 text-sm block mb-2">Punto de Equilibrio</span>
